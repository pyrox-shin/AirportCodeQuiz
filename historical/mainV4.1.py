...
class AirportQuiz:
    ...
    def draw_world_map(self, surface):
        ...
        # 直接將預先畫好的地圖底圖貼上 (只計算平移 offset)
        if self.map_surface_cache:
            surface.blit(self.map_surface_cache, (self.map_offset_x, self.map_offset_y))
        else:
            surface.fill(MAP_BG)
    ...
    def handle_event(self, event):
        ...
        if event.type == pygame.VIDEORESIZE:
            ...
            self.map_surface_cache = None  # 視窗改變時重設快取
            return
